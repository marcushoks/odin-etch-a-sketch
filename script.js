...
gridResoBtns.forEach((btn) => {
  btn.addEventListener("click", (e) => {
    ...
    const columns = parseInt(
      (_a = btn.getAttribute("data-resolution")) !== null && _a !== void 0
        ? _a
        : String(GRID_COLUMNS)
    );
...
rainbowButton === null || rainbowButton === void 0
  ? void 0
  : rainbowButton.addEventListener("click", (e) => {
      ...
      if (rainbowMode) {
        ...
        btnTextColor =
          getComputedStyle(btn).getPropertyValue("--primary-color");
      }
...
function rgbToHsl(rgbString) {
  var _a;
  const matches =
    (_a = rgbString.match(/[0-9]+/g)) === null || _a === void 0
      ? void 0
      : _a.map((match) => parseInt(match));
  let [red, green, blue] =
    matches !== null && matches !== void 0 ? matches : [0, 0, 0];
  red /= 255.0;
  green /= 255.0;
  blue /= 255.0;
